...
module SlamData.Workspace.Card.Chart.ChartOptions.Area where
...
import SlamData.Workspace.Card.Chart.ChartOptions.Common (Key, ChartAxises, commonNameMap, keyCategory, colors, mixAxisLabelAngleAndFontSize, buildChartAxises, mkKey, getShadeColor, toRGBAString)
